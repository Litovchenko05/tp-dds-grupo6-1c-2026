    ...
    return(
        <div className="conteiner">
                ...
                <div className="tittle-container">
                    ...
                    <p>Ingresa tus datos personales a continuación para enviar el comprobante de compra a tu mail.</p>
                </div>
                        ...
                        <div className="form-container">
                            <form onSubmit={handleGuardar}  noValidate={false}>
                                ...
                                <div className="input-div">
                                    ...
                                    maxLength={50}
                                    pattern="[A-Za-z]+"
                                    title="El nombre solo puede contener letras, espacios y apóstrofos." ></input>
                                </div>
                                ...
                                <div className="input-div">
                                    ...
                                    maxLength={50}
                                    pattern="[A-Za-z]+"
                                    title="El apellido solo puede contener letras, espacios y apóstrofos."></input>
                                </div>
                            ...
                            <>
                                ...
                                <div className="carrito-total">
                                    ...
                                    <span>
                                        $
                                        {carrito.reduce(
                                            (total, turno) => total + turno.data.costo,
                                            0
                                        )}
                                    </span>
