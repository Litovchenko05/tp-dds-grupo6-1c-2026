...
const TurnDetailPage = () => {
  ...
  return (
    <div className="turn-detail-container">
      ...
      <div className="turn-header">
        <h1 class="turn-nombre">{obtenerNombreServicio(turno)}</h1>
      ...
      <div className="turn-content">
        <div className="turn-info-section">
          ...
          <div className="turn-description">Fecha: {turno.fecha}</div>
          <div className="turn-description">Hora: {turno.fecha}</div>
          <div className="turn-description">Estado: {turno.estado}</div>
          ...
          <div className="unidades">
            <button className="btn-carrito" onClick={incrementarUnidades}>
              +
            </button>
            <button className="cantidad" disabled>
              {unidades}
            </button>
            <button className="btn-carrito" onClick={decrementarUnidades} disabled={unidades === 0}>
              -
            </button>
          </div>
      ...
      <div className="agregar-container">
        <button
          ...
          disabled={unidades === 0 || obraSocial.trim() === '' || plan.trim() === ''}
        >
          Agregar al carrito
        </button>
      </div>
